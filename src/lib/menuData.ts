...
export const menuData: Record<string, MenuItemData[]> = {
  ...
  Momos: [
    { name: "Steam Veg Momos", description: "Soft steamed veg dumplings served with spicy chutney.", veg: true, variants: HF(40, 80) },
    { name: "Steam Paneer Momos", description: "Steamed paneer filled momos with sharp chutney.", veg: true, variants: HF(50, 100) },
    { name: "Fried Veg Momos", description: "Crispy golden fried veg momos.", veg: true, variants: HF(45, 90) },
    { name: "Fried Paneer Momos", description: "Golden fried paneer momos with a crunch.", veg: true, variants: HF(55, 110) },
    { name: "Gravy Veg Momos", description: "Momos tossed in a spicy red gravy.", veg: true, tag: "Popular", variants: HF(65, 130) },
    { name: "Gravy Paneer Momos", description: "Paneer momos drenched in rich spicy gravy.", veg: true, variants: HF(75, 150) },
    { name: "Malai Veg Momos", description: "Creamy malai sauce coated veg momos.", veg: true, variants: HF(70, 140) },
    { name: "Malai Paneer Momos", description: "Creamy malai paneer momos, mild and rich.", veg: true, variants: HF(80, 160) },
    { name: "Kurkure Veg Momos", description: "Extra crunchy kurkure coated momos.", veg: true, tag: "Bestseller", variants: HF(70, 140) },
    { name: "Kurkure Paneer Momos", description: "Kurkure coated paneer momos with a crunch.", veg: true, variants: HF(80, 160) },
    { name: "Kurkure Cheese Momos (Veg)", price: 109, description: "Crunchy kurkure coating with a cheesy veg filling.", veg: true, tag: "New" },
    { name: "Kurkure Cheese Momos (Paneer)", price: 129, description: "Crunchy kurkure coating with a paneer and cheese filling.", veg: true, tag: "New" },
    ...
    { name: "Pizza Momos (Veg)", price: 99, description: "Fusion pizza style veg momos, cheesy and tangy.", veg: true, tag: "Fusion" },
    { name: "Pizza Momos (Paneer)", price: 119, description: "Fusion pizza style paneer momos, indulgent and rich.", veg: true, tag: "Fusion" },
  ],
  Fries: [
  ...
  Snacks: [
    ...
    { name: "BM Puff (3 pcs)", price: 80, description: "Flaky veg puff stuffed with spiced veggies. House classic.", veg: true },
  ...
  "Royal Combos": [
    ...
    { name: "The Group Platter", price: 299, description: "Cheese Sticks, Veg Sticks, BM Puff, Cheese Corn Triangles, and Garlic Potato Pops. Snack platter for a group of 4 to 5.", veg: true, tag: "Save ₹61" },
  ],
  "Cold Coffee": [
  ...
  Extras: [
    ...
    { name: "Jalapeno Dip", price: 30, description: "Spicy jalapeno dip with a sharp kick.", veg: true },
