  ...
  return (
    <footer className="border-t border-outline-variant/10 bg-surface-container-low">
      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            <div className="flex items-center gap-2">
              ...
              <span className="font-[var(--font-heading)] text-lg font-bold text-on-surface">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="font-[var(--font-heading)] text-sm font-semibold uppercase tracking-wider text-primary">
              Quick Links
            </h3>
        ...
        {/* Social + Copyright */}
        <div className="mt-10 flex flex-col items-center justify-between gap-4 border-t border-outline-variant/10 pt-8 sm:flex-row">
          <p className="text-xs text-on-surface/40">
            &copy; {new Date().getFullYear()} Burger Minister. All rights reserved.
          </p>
