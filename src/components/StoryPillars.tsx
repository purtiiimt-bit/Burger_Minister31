...
const pillars = [
  {
    ...
    title: "The Pledge",
    body:
      "100% pure vegetarian, always. No eggs, no compromises — ever. FSSAI-compliant, hygiene-first kitchen. Sealed for safety.",
  },
  {
    num: "02",
    title: "The Kitchen",
  ...
  },
  {
    ...
    title: "The Promise",
    body:
      "Pocket-friendly prices, generous portions, and a smile from Bhaiya. Pickup, dine-in, and delivery across Sector 58, 59, 62 & 63 — till 3 AM, every single day.",
  },
];
        ...
        <div className="grid items-start gap-12 lg:grid-cols-2">
          ...
          <div>
            ...
            <blockquote className="mt-8 border-l-2 border-primary/40 pl-5 text-base italic leading-relaxed text-on-surface/70">
              &ldquo;Bhaiya bohot ache hai, khaana bhi acha hai, must try
              everything. All night delivery available.&rdquo;
